...
Follow these steps to get the best results from WorkZo:

1️⃣ Upload or create your CV  
2️⃣ Go to **Understand Job** and paste a job description  
3️⃣ See compatibility score and missing skills  
4️⃣ Improve your CV using **Improve CV**  
5️⃣ Practice interview answers in **Mock Interview**

⚡ Tip: The more detailed your CV, the better the AI suggestions.
""")

    st.markdown(f"## {t('start_here')}")
