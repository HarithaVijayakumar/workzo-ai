...
def get_country_specific_quick_prompts(country_name: str):
    ...
    if country == "germany":
        return [
            ("mock questions", "Give me a German B1/B2 mock test practice set with example questions and answers."),
...
def show_dashboard():
    ...
    with st.sidebar:
        ...
        <div class='workzo-sidebar-brand-wrap'>
            ...
            <div class='workzo-sidebar-version'>Beta V9.25 · Country scope fixed</div>
        </div>
        """, unsafe_allow_html=True)
...
""")
    ...
    st.divider()
    st.caption("WORKZO AI V9.32 • Beta • Readiness + Resume Quality Fixed")
