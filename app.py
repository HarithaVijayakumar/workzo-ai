...
with header_col2:
    ...
    <div style="display:flex; align-items:center; gap:10px; flex-wrap:wrap;">
        ...
        <span class="beta-badge">BETA V5.2</span>
    </div>
...
def show_onboarding():
    ...
    st.info("Beta privacy note: WorkZo tracks anonymous usage such as selected features and session duration to improve the product. It does not store your CV text, email, phone number, or personal documents.")
...
"""
    ...
    elif page == "Beta Analytics":
        track_feature_view("Beta Analytics")
        render_beta_analytics_summary()

    st.divider()
    st.caption("WORKZO AI V5.2 • Status-aware onboarding • Stronger AI outputs • Improved document tools")
