...
def generate_next_best_steps(cv_text: str, country_name: str, current_role: str, suggested_roles: str) -> str:
    prompt = f"""
Country: {country_name}
...
Create a concise personalized action center.

Return in this exact structure:
1. Best Immediate Goal
2. This Week's 3 Priority Actions
3. Best Role Cluster to Target
4. One Resume Fix That Will Help Most
5. One Skill to Improve Next
6. One Message to Send Today
...
with header_col2:
    ...
    <div style="display:flex; align-items:center; gap:10px; flex-wrap:wrap;">
        ...
        <span class="beta-badge">BETA V4.3</span>
    </div>
...
def show_dashboard():
    ...
    if page == txt("dashboard"):
        ...
        with assist_tab1:
            ...
            cv_for_jobs = st.text_area(txt("your_cv"), value=st.session_state.cv_text, height=240, key="job_assist_cv")
...
"""
    ...
    st.divider()
    st.caption("WORKZO AI V4.3 • Redesigned dashboard • Modern SaaS UI • Next Best Step action center")
